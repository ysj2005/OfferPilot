...
import {BookOpen, BriefcaseBusiness, Calendar, ChevronRight, Database, FileStack, ListChecks, MessageSquare, Moon, Settings, Sparkles, Sun, Users,} from 'lucide-react';
...
export default function Layout() {
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      title: '求职投递',
      items: [
        { id: 'job-agent', path: '/job-agent', label: '投递工作台', icon: BriefcaseBusiness, description: 'Agent 投递与确认' },
        { id: 'job-agent-jobs', path: '/job-agent/jobs', label: '岗位池', icon: ListChecks, description: '查看采集岗位' },
        { id: 'job-agent-monitor', path: '/job-agent/monitor', label: '监测执行', icon: MessageSquare, description: '处理 HR 回复' },
        { id: 'job-agent-config', path: '/job-agent/config', label: '投递配置', icon: Settings, description: 'Agent 参数设置' },
      ],
    },
    {
      id: 'knowledge',
