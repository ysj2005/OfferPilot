...
const JobAgentJobsPage = lazy(() => import('./pages/JobAgentJobsPage'));
const JobAgentMonitorPage = lazy(() => import('./pages/JobAgentMonitorPage'));
const JobAgentConfigPage = lazy(() => import('./pages/JobAgentConfigPage'));
      ...
      <Suspense fallback={<Loading />}>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            {/* 求职投递 */}
            <Route path="job-agent" element={<JobAgentPage />} />
            <Route path="job-agent/jobs" element={<JobAgentJobsPage />} />
            <Route path="job-agent/monitor" element={<JobAgentMonitorPage />} />
            <Route path="job-agent/config" element={<JobAgentConfigPage />} />
